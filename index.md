...
### **Introduction to Web Development & Environment Setup**
...
#### **Hands-On Student Activity Overview**
- **Tasks:**
...
#### **Student Activity Step 1 - Installing Tools**
- **Instructions:**
  - **Visual Studio Code:**
...
#### **Student Activity Step 2 - Initialize Git Repository**
- **Instructions:**
...
#### **Student Activity Step 3 - Create "Hello World" Application**
- **Instructions:**
...
#### **Student Activity Step 1 - JavaScript Utilities Library**
- **Instructions:**
...
#### **Student Activity Step 2 - Fetching Data with async/await**
- **Instructions:**
  1. Create a `test.js` to import and test these functions 
  2. In `test.js`, use the `fetchData` function to get data from [JSONPlaceholder](https://jsonplaceholder.typicode.com/posts)
  <!-- 3. Solution:
     ```javascript
...
#### **Student Activity Step 1 - Cloning the Repository**
- **Instructions:**
...
#### **Student Activity Step 2 - Creating a Feature Branch**
- **Instructions:**
...
#### **Student Activity Step 3 - Merging Branches**
- **Instructions:**
...
#### **Student Activity Step 4 - Resolving Merge Conflicts**
...
#### **Student Activity Step 2 - Implementing Middleware**
- **Instructions:**
...
#### **Student Activity Step 1 - Initializing npm Project**
- **Instructions:**
  1. Open terminal in VS Code
...
#### **Student Activity Step 2 - Installing Packages**
- **Instructions:**
...
#### **Student Activity Step 3 - Managing package.json**
- **Tasks:**
...
#### **Student Activity Step 4 - Creating Custom npm Scripts**
- **Instructions:**
...
#### *Backend Development with Node.js and MySQL**
...
- **INSERT:** Add new records
  ```sql
  INSERT INTO users (name, email, password) VALUES ('Pikachu', 'Pikachu@example.com', 'password123');
  ```
- **UPDATE:** Modify existing records
  ```sql
  UPDATE users SET email = 'Pikachu_new@example.com' WHERE id = 1;
  ```
...
#### **Student Activity Step 1 - Creating the Database**
- **Instructions:**
...
#### **Student Activity Step 2 - Creating Tables**
- **Instructions:**
...
#### **Student Activity Step 3 - Inserting Sample Data**
- **Instructions:**
  1. Insert into `users`:
     ```sql
     INSERT INTO users (name, email, password) VALUES
     ('Pikachu Johnson', 'Pikachu@example.com', 'hashedpassword1'),
...
#### **Student Activity Step 4 - Executing CRUD Operations**
- **SELECT Examples:**
  ```sql
  SELECT * FROM users;
  SELECT name, email FROM users WHERE id = 1;
